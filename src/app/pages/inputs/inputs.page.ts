...
import { UploadIcon, ListIcon, ButtonIcon, TextIcon, CheckboxIcon, UserAddIcon, UserEditIcon, UserIcon, UserDeleteIcon, HamburgerIcon } from '../../ncss/icons';
...
@Component({
  ...
  imports: [Select, Card, Container, RouterLink, Button, UploadIcon, ListIcon, ButtonIcon, TextIcon, CheckboxIcon, Checkbox, Switch, SquareButton, Password, FileUpload, UserAddIcon, UserEditIcon, UserIcon, UserDeleteIcon, HamburgerIcon],
