...
export class TablesPage {
  ...
  public tableData = [
    { id: 1, name: 'John Doe', email: 'john@example.com', age: 28, role: 'Developer', active: true, appliedOn: '2024-01-10T09:15:00' },
    { id: 2, name: 'Jane Smith', email: 'jane@example.com', age: 34, role: 'Designer', active: true, appliedOn: '2024-01-22T14:30:00' },
    { id: 3, name: 'Bob Johnson', email: 'bob@example.com', age: 45, role: 'Manager', active: false, appliedOn: '2024-02-05T11:00:00' },
    { id: 4, name: 'Alice Williams', email: 'alice@example.com', age: 29, role: 'Developer', active: true, appliedOn: '2024-02-14T08:45:00' },
    { id: 5, name: 'Charlie Brown', email: 'charlie@example.com', age: 52, role: 'Director', active: true, appliedOn: '2024-03-01T10:20:00' },
    { id: 6, name: 'Diana Prince', email: 'diana@example.com', age: 31, role: 'Designer', active: true, appliedOn: '2024-03-12T15:00:00' },
    { id: 7, name: 'Ethan Hunt', email: 'ethan@example.com', age: 38, role: 'Developer', active: false, appliedOn: '2024-03-25T09:30:00' },
    { id: 8, name: 'Fiona Green', email: 'fiona@example.com', age: 27, role: 'Analyst', active: true, appliedOn: '2024-04-08T13:15:00' },
    { id: 9, name: 'George Miller', email: 'george@example.com', age: 41, role: 'Manager', active: true, appliedOn: '2024-04-19T10:00:00' },
    { id: 10, name: 'Hannah Lee', email: 'hannah@example.com', age: 33, role: 'Developer', active: true, appliedOn: '2024-05-02T11:45:00' },
    { id: 11, name: 'Ian Malcolm', email: 'ian@example.com', age: 47, role: 'Scientist', active: false, appliedOn: '2024-05-14T14:00:00' },
    { id: 12, name: 'Julia Roberts', email: 'julia@example.com', age: 36, role: 'Designer', active: true, appliedOn: '2024-05-27T09:00:00' },
    { id: 13, name: 'Kevin Hart', email: 'kevin@example.com', age: 29, role: 'Developer', active: true, appliedOn: '2024-06-10T16:30:00' },
    { id: 14, name: 'Laura Palmer', email: 'laura@example.com', age: 25, role: 'Intern', active: true, appliedOn: '2024-06-21T08:00:00' },
    { id: 15, name: 'Mike Ross', email: 'mike@example.com', age: 30, role: 'Developer', active: true, appliedOn: '2024-07-03T10:30:00' },
    { id: 16, name: 'Nancy Drew', email: 'nancy@example.com', age: 26, role: 'Detective', active: true, appliedOn: '2024-07-15T13:00:00' },
    { id: 17, name: 'Oscar Wilde', email: 'oscar@example.com', age: 43, role: 'Writer', active: true, appliedOn: '2024-07-29T11:15:00' },
    { id: 18, name: 'Patricia Clark', email: 'patricia@example.com', age: 35, role: 'Manager', active: true, appliedOn: '2024-08-08T09:45:00' },
    { id: 19, name: 'Quinn Turner', email: 'quinn@example.com', age: 29, role: 'Developer', active: false, appliedOn: '2024-08-20T14:00:00' },
    { id: 20, name: 'Rachel Green', email: 'rachel@example.com', age: 32, role: 'Designer', active: true, appliedOn: '2024-09-02T10:15:00' },
    { id: 21, name: 'Samuel Jackson', email: 'samuel@example.com', age: 48, role: 'Director', active: true, appliedOn: '2024-09-13T15:30:00' },
    { id: 22, name: 'Tina Fey', email: 'tina@example.com', age: 40, role: 'Developer', active: true, appliedOn: '2024-09-26T09:00:00' },
    { id: 23, name: 'Uma Thurman', email: 'uma@example.com', age: 37, role: 'Analyst', active: false, appliedOn: '2024-10-07T11:30:00' },
    { id: 24, name: 'Victor Stone', email: 'victor@example.com', age: 31, role: 'Developer', active: true, appliedOn: '2024-10-18T13:45:00' },
    { id: 25, name: 'Wendy Adams', email: 'wendy@example.com', age: 28, role: 'Designer', active: true, appliedOn: '2024-11-01T08:30:00' },
    { id: 26, name: 'Xavier Charles', email: 'xavier@example.com', age: 55, role: 'Director', active: true, appliedOn: '2024-11-12T10:00:00' },
    { id: 27, name: 'Yolanda Martinez', email: 'yolanda@example.com', age: 33, role: 'Manager', active: true, appliedOn: '2024-11-25T14:15:00' },
    { id: 28, name: 'Zachary Taylor', email: 'zachary@example.com', age: 42, role: 'Developer', active: false, appliedOn: '2024-12-06T09:00:00' },
    { id: 29, name: 'Amy Santiago', email: 'amy@example.com', age: 30, role: 'Analyst', active: true, appliedOn: '2024-12-17T11:00:00' },
    { id: 30, name: 'Bruce Wayne', email: 'bruce@example.com', age: 38, role: 'Developer', active: true, appliedOn: '2025-01-03T10:30:00' },
    { id: 31, name: 'Catherine Zeta', email: 'catherine@example.com', age: 44, role: 'Designer', active: true, appliedOn: '2025-01-14T14:00:00' },
    { id: 32, name: 'David Martinez', email: 'david@example.com', age: 27, role: 'Intern', active: true, appliedOn: '2025-01-27T08:45:00' },
    { id: 33, name: 'Emma Watson', email: 'emma@example.com', age: 29, role: 'Developer', active: true, appliedOn: '2025-02-10T09:15:00' },
    { id: 34, name: 'Frank Castle', email: 'frank@example.com', age: 41, role: 'Manager', active: false, appliedOn: '2025-02-21T13:30:00' },
    { id: 35, name: 'Grace Hopper', email: 'grace@example.com', age: 35, role: 'Developer', active: true, appliedOn: '2025-03-06T10:00:00' },
    { id: 36, name: 'Henry Cavill', email: 'henry@example.com', age: 36, role: 'Designer', active: true, appliedOn: '2025-03-17T15:45:00' },
    { id: 37, name: 'Iris West', email: 'iris@example.com', age: 28, role: 'Analyst', active: true, appliedOn: '2025-03-28T09:30:00' },
    { id: 38, name: 'Jack Sparrow', email: 'jack@example.com', age: 45, role: 'Developer', active: false, appliedOn: '2025-04-10T11:15:00' },
    { id: 39, name: 'Karen Page', email: 'karen@example.com', age: 32, role: 'Designer', active: true, appliedOn: '2025-04-22T14:00:00' },
    { id: 40, name: 'Leonard Hofstadter', email: 'leonard@example.com', age: 37, role: 'Scientist', active: true, appliedOn: '2025-05-05T10:45:00' },
    { id: 41, name: 'Monica Geller', email: 'monica@example.com', age: 34, role: 'Manager', active: true, appliedOn: '2025-05-16T08:00:00' },
    { id: 42, name: 'Natasha Romanoff', email: 'natasha@example.com', age: 35, role: 'Developer', active: true, appliedOn: '2025-05-27T12:30:00' },
    { id: 43, name: 'Oliver Queen', email: 'oliver@example.com', age: 39, role: 'Director', active: false, appliedOn: '2025-06-09T09:00:00' },
    { id: 44, name: 'Phoebe Buffay', email: 'phoebe@example.com', age: 36, role: 'Designer', active: true, appliedOn: '2025-06-20T13:15:00' },
    { id: 45, name: 'Quentin Beck', email: 'quentin@example.com', age: 40, role: 'Developer', active: true, appliedOn: '2025-07-02T10:30:00' },
    { id: 46, name: 'Rose Tyler', email: 'rose@example.com', age: 26, role: 'Analyst', active: true, appliedOn: '2025-07-14T14:45:00' },
    { id: 47, name: 'Steve Rogers', email: 'steve@example.com', age: 42, role: 'Manager', active: true, appliedOn: '2025-07-25T09:15:00' },
    { id: 48, name: 'Tara King', email: 'tara@example.com', age: 29, role: 'Developer', active: false, appliedOn: '2025-08-07T11:00:00' },
    { id: 49, name: 'Ursula Vernon', email: 'ursula@example.com', age: 31, role: 'Designer', active: true, appliedOn: '2025-08-19T15:30:00' },
    { id: 50, name: 'Violet Baudelaire', email: 'violet@example.com', age: 24, role: 'Intern', active: true, appliedOn: '2025-09-01T08:45:00' },
    { id: 51, name: 'Walter White', email: 'walter@example.com', age: 50, role: 'Scientist', active: true, appliedOn: '2025-09-12T10:00:00' },
    { id: 52, name: 'Xena Warrior', email: 'xena@example.com', age: 33, role: 'Developer', active: true, appliedOn: '2025-09-24T13:30:00' },
    { id: 53, name: 'Yvonne Strahovski', email: 'yvonne@example.com', age: 37, role: 'Analyst', active: false, appliedOn: '2025-10-07T09:45:00' },
    { id: 54, name: 'Zoe Saldana', email: 'zoe@example.com', age: 38, role: 'Designer', active: true, appliedOn: '2025-10-18T14:00:00' },
    { id: 55, name: 'Aaron Paul', email: 'aaron@example.com', age: 39, role: 'Developer', active: true, appliedOn: '2025-10-30T10:15:00' },
    { id: 56, name: 'Betty Cooper', email: 'betty@example.com', age: 25, role: 'Analyst', active: true, appliedOn: '2025-11-11T08:30:00' },
    { id: 57, name: 'Clark Kent', email: 'clark@example.com', age: 32, role: 'Developer', active: true, appliedOn: '2025-11-22T12:00:00' },
    { id: 58, name: 'Dorothy Gale', email: 'dorothy@example.com', age: 27, role: 'Designer', active: false, appliedOn: '2025-12-04T09:30:00' },
    { id: 59, name: 'Edward Elric', email: 'edward@example.com', age: 22, role: 'Intern', active: true, appliedOn: '2025-12-15T15:00:00' },
    { id: 60, name: 'Felicity Smoak', email: 'felicity@example.com', age: 30, role: 'Developer', active: true, appliedOn: '2026-01-05T10:45:00' },
    { id: 61, name: 'Garfield Logan', email: 'garfield@example.com', age: 28, role: 'Designer', active: true, appliedOn: '2026-01-16T13:00:00' },
    { id: 62, name: 'Hermione Granger', email: 'hermione@example.com', age: 31, role: 'Manager', active: true, appliedOn: '2026-01-28T09:15:00' },
    { id: 63, name: 'Isaac Newton', email: 'isaac@example.com', age: 46, role: 'Scientist', active: true, appliedOn: '2026-02-09T11:30:00' },
    { id: 64, name: 'Jessica Jones', email: 'jessica@example.com', age: 34, role: 'Developer', active: false, appliedOn: '2026-02-20T14:45:00' },
    { id: 65, name: 'Kara Danvers', email: 'kara@example.com', age: 27, role: 'Analyst', active: true, appliedOn: '2026-03-04T08:00:00' },
    { id: 66, name: 'Luke Cage', email: 'luke@example.com', age: 36, role: 'Developer', active: true, appliedOn: '2026-03-16T10:30:00' },
    { id: 67, name: 'Matt Murdock', email: 'matt@example.com', age: 35, role: 'Manager', active: true, appliedOn: '2026-03-27T13:15:00' },
    { id: 68, name: 'Nora Allen', email: 'nora@example.com', age: 29, role: 'Designer', active: true, appliedOn: '2026-04-08T09:00:00' },
    { id: 69, name: 'Ororo Munroe', email: 'ororo@example.com', age: 38, role: 'Developer', active: false, appliedOn: '2026-04-19T15:30:00' },
    { id: 70, name: 'Peter Parker', email: 'peter@example.com', age: 24, role: 'Intern', active: true, appliedOn: '2026-04-30T10:00:00' },
    { id: 71, name: 'Quincy Adams', email: 'quincy@example.com', age: 43, role: 'Director', active: true, appliedOn: '2026-05-11T11:45:00' },
    { id: 72, name: 'Raven Darkholme', email: 'raven@example.com', age: 40, role: 'Developer', active: true, appliedOn: '2026-05-22T14:00:00' },
    { id: 73, name: 'Selina Kyle', email: 'selina@example.com', age: 33, role: 'Designer', active: true, appliedOn: '2026-05-28T09:30:00' },
    { id: 74, name: 'Tony Stark', email: 'tony@example.com', age: 48, role: 'Director', active: true, appliedOn: '2024-01-15T16:00:00' },
    { id: 75, name: 'Ulysses Grant', email: 'ulysses@example.com', age: 51, role: 'Manager', active: false, appliedOn: '2024-02-28T09:15:00' },
    { id: 76, name: 'Veronica Mars', email: 'veronica@example.com', age: 28, role: 'Analyst', active: true, appliedOn: '2024-04-03T13:30:00' },
    { id: 77, name: 'Wade Wilson', email: 'wade@example.com', age: 37, role: 'Developer', active: true, appliedOn: '2024-05-20T10:00:00' },
    { id: 78, name: 'Ximena Rodriguez', email: 'ximena@example.com', age: 26, role: 'Designer', active: true, appliedOn: '2024-07-08T14:30:00' },
    { id: 79, name: 'Yara Greyjoy', email: 'yara@example.com', age: 32, role: 'Manager', active: true, appliedOn: '2024-08-25T09:45:00' },
    { id: 80, name: 'Zara Larsson', email: 'zara@example.com', age: 25, role: 'Developer', active: false, appliedOn: '2024-10-12T11:00:00' },
    { id: 81, name: 'Arthur Curry', email: 'arthur@example.com', age: 35, role: 'Developer', active: true, appliedOn: '2024-11-28T15:15:00' },
    { id: 82, name: 'Barbara Gordon', email: 'barbara@example.com', age: 29, role: 'Analyst', active: true, appliedOn: '2025-01-20T08:30:00' },
    { id: 83, name: 'Connor Kent', email: 'connor@example.com', age: 23, role: 'Intern', active: true, appliedOn: '2025-03-10T10:15:00' },
    { id: 84, name: 'Donna Troy', email: 'donna@example.com', age: 31, role: 'Designer', active: true, appliedOn: '2025-04-28T13:45:00' },
    { id: 85, name: 'Eric Brooks', email: 'eric@example.com', age: 44, role: 'Developer', active: false, appliedOn: '2025-06-14T09:00:00' },
    { id: 86, name: 'Frost Emma', email: 'frost@example.com', age: 39, role: 'Manager', active: true, appliedOn: '2025-08-01T11:30:00' },
    { id: 87, name: 'Gwen Stacy', email: 'gwen@example.com', age: 26, role: 'Developer', active: true, appliedOn: '2025-09-18T14:15:00' },
    { id: 88, name: 'Hal Jordan', email: 'hal@example.com', age: 38, role: 'Developer', active: true, appliedOn: '2025-11-05T10:30:00' },
    { id: 89, name: 'Ivy Pepper', email: 'ivy@example.com', age: 30, role: 'Designer', active: true, appliedOn: '2025-12-22T08:45:00' },
    { id: 90, name: 'James Rhodes', email: 'james@example.com', age: 42, role: 'Director', active: true, appliedOn: '2026-02-06T13:00:00' },
    { id: 91, name: 'Kate Kane', email: 'kate@example.com', age: 34, role: 'Manager', active: false, appliedOn: '2026-03-20T09:15:00' },
    { id: 92, name: 'Logan Howlett', email: 'logan@example.com', age: 47, role: 'Developer', active: true, appliedOn: '2026-05-01T15:00:00' },
    { id: 93, name: 'May Parker', email: 'may@example.com', age: 28, role: 'Analyst', active: true, appliedOn: '2024-03-18T10:45:00' },
    { id: 94, name: 'Ned Leeds', email: 'ned@example.com', age: 25, role: 'Developer', active: true, appliedOn: '2024-06-05T12:00:00' },
    { id: 95, name: 'Odin Borson', email: 'odin@example.com', age: 60, role: 'Director', active: true, appliedOn: '2024-09-22T09:30:00' },
    { id: 96, name: 'Peggy Carter', email: 'peggy@example.com', age: 41, role: 'Manager', active: false, appliedOn: '2024-12-09T14:00:00' },
    { id: 97, name: 'Riri Williams', email: 'riri@example.com', age: 22, role: 'Intern', active: true, appliedOn: '2025-02-25T10:15:00' },
    { id: 98, name: 'Scott Lang', email: 'scott@example.com', age: 36, role: 'Developer', active: true, appliedOn: '2025-05-12T13:30:00' },
    { id: 99, name: 'Thor Odinson', email: 'thor@example.com', age: 45, role: 'Developer', active: true, appliedOn: '2025-08-28T09:00:00' },
    { id: 100, name: 'Wanda Maximoff', email: 'wanda@example.com', age: 30, role: 'Designer', active: true, appliedOn: '2025-11-14T11:45:00' },
  ];

  // Sliced data for the non-virtualized table (stable reference)
  public tableDataSliced = this.tableData.slice(0, 30);

  // Columns config for the first table — shows appliedOn instead of id
  public tableColumnsConfig: Column[] = [
    { column: 'appliedOn', displayValue: 'Applied On' },
    { column: 'name', displayValue: 'Name' },
    { column: 'email', displayValue: 'Email' },
    { column: 'age', displayValue: 'Age' },
    { column: 'role', displayValue: 'Role' },
    { column: 'active', displayValue: 'Active' },
  ];
  ...
  // Date auto-detection code examples
  public dateExampleTS = `
    export class TablesPage {
      public employees = [
        {
          // ISO 8601 string — recommended, works in all environments
          appliedOn: '2024-03-15T09:30:00',
          name: 'John Doe',
          role: 'Developer'
        },
        {
          // JavaScript Date object — also auto-detected
          appliedOn: new Date('2024-06-20T14:00:00'),
          name: 'Jane Smith',
          role: 'Designer'
        }
      ];
  ...
  public dateFormatNote = `
    Accepted date value formats:

    ✓ ISO 8601 string:  '2024-03-15T09:30:00'
                        '2024-03-15T09:30:00.000Z'

    ✓ JavaScript Date:  new Date('2024-03-15T09:30:00')
                        new Date(2024, 2, 15, 9, 30, 0)

    ✗ Date-only string: '2024-03-15'   (not detected — no time component)
    ✗ Locale string:    'Mar 15, 2024' (not detected — not ISO format)

    Display format (read-only):  YYYY Mon DD HH:MM
    Example:                     2024 Mar 15 09:30

    Filter input format:         yyyy/mm/dd
    Example:                     2024/03/15
  `;
  ...
  public regularTableTS = `
    ...
    import { CommonModule } from '@angular/common';
    import { Table, FilterPreset, Column } from '../../ncss/tables/table/table';
